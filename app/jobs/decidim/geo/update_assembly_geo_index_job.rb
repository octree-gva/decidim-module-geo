        ...
        class UpdateAssemblyGeoIndexJob < ::ApplicationJob
          ...
          def sync_assembly
            ...
            upsert_index(assembly.id, manifest_name,
              ...
              puts "Error: can not geo-index this assembly: #{e}"
              false
          end

            def with_dates(decidim_geo_hash)
                if assembly.included_at
                    decidim_geo_hash[:start_date] = assembly.included_at.to_date
                end
                if assembly.closing_date
                    decidim_geo_hash[:end_date] = assembly.closing_date.to_date
                end
                decidim_geo_hash
            end
