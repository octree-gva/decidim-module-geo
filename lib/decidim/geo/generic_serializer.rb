            ...
            included do
                ...
                def scope
                    @scope ||= if resource.class.include? Decidim::HasComponent
                        scope_for_resource 
                    elsif resource.class == Decidim::Component
                        scope_for_component 
                ...
                def scope_for_participatory_space(space=nil)
                    space = resource unless space

                    @scope_for_participatory_space ||=  if space && space.scope
                        space.scope 
                    end
                end

                def scope_for_component(component=nil)
                    component = resource unless component
                ...
                def scope_for_resource
                    @scope_for_resource ||= if resource.scope.present?
                    resource.scope 
                    else
                        scope_for_component(resource.component)
                    end
                end         
            end
        end
