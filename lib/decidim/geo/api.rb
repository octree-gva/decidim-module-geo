...
module Decidim
  module Geo
    ...
    autoload :NotScopeInputFilter, "decidim/api/input_filters/not_scope_input_filter"
    ...
    autoload :ProcessGroupInputFilter, "decidim/api/input_filters/process_group_input_filter"
